    ...
    <div>
      ...
      >
        ...
        <input
          ...
          id={name}
          value={
            type === KTFormInputType.datetime
              ? moment(value).format('YYYY-MM-DDTHH:mm:ss')
              : type === KTFormInputType.time
